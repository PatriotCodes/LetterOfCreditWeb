...
var StaticMapComponent = (function () {
    ...
    StaticMapComponent.prototype.ngOnInit = function () {
        ...
        this.gtService.allNodes[global.buyerName] = this.markerBuyer;
        this.gtService.allNodes[global.sellerName] = this.markerSeller;
        this.gtService.allNodes[global.issuingBankName] = this.markerIssuing;
        this.gtService.allNodes[global.advisingBankName] = this.markerAdvising;
    };
