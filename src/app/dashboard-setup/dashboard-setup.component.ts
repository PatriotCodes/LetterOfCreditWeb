...
export class DashboardSetupComponent implements AfterViewInit, OnInit {
  ...
  constructor(public identityService: IdentityService, private dialog: MatDialog, public urlProvider: UrlProviderService) { }
  ...
  launchPage(role: string, port: string, event: any, cash = false) {
    ...
    let url = this.urlProvider.url + port + path;
