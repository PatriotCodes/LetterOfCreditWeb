...
var ShipComponent = (function () {
    function ShipComponent(locService, modalComponent, statusService) {
    ...
    ShipComponent.prototype.confirm = function () {
        ...
        this.locService.shipGoods(this.id)
            ...
            Rx_1.Observable.interval(1300).subscribe(function (x) {
                _this.statusService.shipAnimation = false;
                _this.modalComponent.close();
            });
        })
            .catch(function (err) { return _this.modalComponent.close(); });
    };
...
ShipComponent = __decorate([
    ...
    __metadata("design:paramtypes", [loc_service_1.LocService, ship_modal_component_1.ShipModalComponent, status_service_1.StatusService])
], ShipComponent);
