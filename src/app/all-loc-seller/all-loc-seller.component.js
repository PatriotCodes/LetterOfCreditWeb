...
var invoice_component_1 = require("../invoice-create/invoice.component");
var AllLocSellerComponent = (function () {
    function AllLocSellerComponent(locService, modalService, tourService, refreshService, dialog) {
        var _this = this;
    ...
    AllLocSellerComponent.prototype.createInvoice = function () {
        this.dialog.open(invoice_component_1.InvoiceCreateComponent);
    };
    AllLocSellerComponent.prototype.shipGoods = function (id) {
        ...
        this.bsModalRef.content.title = 'Confirm Shipped - ' + this.locs.filter(function (x) { return x.orderRef === id; })[0].description;
...
AllLocSellerComponent = __decorate([
    ...
    __metadata("design:paramtypes", [loc_service_1.LocService, modal_1.BsModalService,
        tour_service_1.TourService, refresh_service_1.RefreshService, material_1.MatDialog])
