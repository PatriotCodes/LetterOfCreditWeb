...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_url_provider_service__ = __webpack_require__("./src/app/services/url-provider.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CashIssuanceComponent = (function () {
    function CashIssuanceComponent(dialogRef, portService, urlProvider) {
        this.dialogRef = dialogRef;
...
CashIssuanceComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatDialogRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatDialogRef */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_port_provider_service__["a" /* PortProviderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_port_provider_service__["a" /* PortProviderService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_url_provider_service__["a" /* UrlProviderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_url_provider_service__["a" /* UrlProviderService */]) === "function" && _c || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_url_provider_service__ = __webpack_require__("./src/app/services/url-provider.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardSetupComponent = (function () {
    function DashboardSetupComponent(identityService, dialog, urlProvider) {
        this.identityService = identityService;
        this.dialog = dialog;
        this.urlProvider = urlProvider;
        this.angleStart = -360;
    ...
    DashboardSetupComponent.prototype.launchPage = function (role, port, event, cash) {
        ...
        var url = this.urlProvider.url + port + path;
...
var IdentityService = (function () {
    ...
    IdentityService.prototype.scanForPeers = function () {
        ...
        if (this.scannedPeers.length === 0) {
            ...
            var this_2 = this;
            for (var _i = 0, _a = this.portService.nodes; _i < _a.length; _i++) {
                var i = _a[_i];
                _loop_2(i);
            }
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_url_provider_service__ = __webpack_require__("./src/app/services/url-provider.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StartupCheckComponent = (function () {
    function StartupCheckComponent(http, router, portProvider, urlProvider) {
        this.http = http;
        this.router = router;
    ...
    StartupCheckComponent.prototype.scanForNodes = function () {
        ...
        for (var _i = 0, _a = this.portProvider.nodes; _i < _a.length; _i++) {
            var i = _a[_i];
            var url = this.urlProvider.url + i + '/webserver/loc/api/loc/me';
            this.http.get(url)
                .toPromise()
